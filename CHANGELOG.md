...
- Thunderbird L3 verify requires dest `profiles.ini` to list the recovered profile and keeps `key4.db` paired with `logins.json`/`logins.db`, matching the Firefox transplant checks.
