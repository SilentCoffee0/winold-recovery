...
- Game-save, Outlook PST, KeePass vault, library catalog, Terminal, Obsidian, GPG, SSH, VS Code, Thunderbird, Syncthing identity files, and Anki L3 verify require dest file lengths to match the source, so an empty or truncated restore fails.
