...
- `GameSaves.rules.json` — Saved Games, My Games, Steam userdata, Unreal `Saved\SaveGames`, GOG Galaxy Applications, `.minecraft`, Epic, Ubisoft, EA/Origin, Battle.net/Blizzard, Riot Games, Steam-compatible AppData save folders
