...
- M1 item 6: implementation complete on 13 Sep 2026. Optional SHA-256 hashing of clean file nodes at most 64 MB runs after scan when the Scan checkbox is set, stores hex digests in session kv keyed by node, and never opens cloud-placeholder or problem files.
