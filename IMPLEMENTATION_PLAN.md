...
- M2: implementation complete on 13 Sep 2026. Embedded HighValue/Regeneratable/GameSaves/Sensitive JSON rules badge nodes, mark sensitive files, apply suggested Restore to standard folders and high-value Restore rules, and suggest Leave Behind only for whole `AppData`. Regeneratable and unclassified nodes stay Undecided (I6). Decide Cards include High-value and Regeneratable summaries. Contributor schema is in `docs/classification-rules.md`.
