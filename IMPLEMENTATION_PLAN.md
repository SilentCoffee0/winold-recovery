...
- M7 fourth slice complete on 13 Sep 2026. In-app redacted session log viewer (Log no longer shells Explorer as the primary view); middle-ellipsis paths with full path in Inspect; compact Cards/Files/Inspect tabs below 1200 px; space-budget copy for near-limit and will-not-fit. Interactive FlaUI, SignPath, the VM matrix, 1M-node memory, and elevated/manual M0 checks remain pending. Do not tag `v0.1.0` or `v0.1.0-m0`.
