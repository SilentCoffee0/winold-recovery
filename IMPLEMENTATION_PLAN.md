...
- M7 fifth slice complete on 13 Sep 2026. Source picker dates and estimated deletion; Browse folder; Pause/Resume scan; live skipped-item counters; thousands separators and byte units in the Files list. Interactive FlaUI, SignPath, the VM matrix, 1M-node memory, and elevated/manual M0 checks remain pending. Do not tag `v0.1.0` or `v0.1.0-m0`.
