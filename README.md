...
> **Status: early implementation (Milestone 0).** The .NET 10 solution, WPF shell, project boundaries, administrator manifest, x64 single-file publish, privilege enablement, source-write guard, SQLite session database, and synthetic fixture generator are in place. Technical spikes and CI are still in progress.
