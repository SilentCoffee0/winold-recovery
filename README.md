...
> **Status: Milestone 7 in progress.** Crash-resume, absent-app cards, per-folder destinations, mixed-byte bars, and disk-full Resume chrome exist. Remaining: interactive FlaUI, code signing, the manual VM matrix, a real 200 MB VHDX disk-full test, a 1M-node memory pass, and elevated/manual M0 checks. The M0 tag has not been created.
