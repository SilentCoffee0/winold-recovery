...
> **Status: early implementation (Milestone 0).** The .NET 10 solution, WPF shell, project boundaries, administrator manifest, x64 single-file publish, privilege enablement, source-write guard, and SQLite session database are in place. Fixtures and technical spikes are still in progress.
