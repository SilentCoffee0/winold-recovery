...
public sealed class AccessibilityMarkupTests
{
    ...
    public void MainWindow_DeclaresNarratorNamesForTheSixSteps()
    {
        ...
        Assert.Contains("LaterOverviewCardCommand", xaml, StringComparison.Ordinal);
        Assert.Contains("Skip this card for now", xaml, StringComparison.Ordinal);
        ...
        Assert.Contains("AutomationProperties.AutomationId=\"AddSyncthingFolderButton\"", xaml, StringComparison.Ordinal);
        Assert.Contains("Add a Syncthing folder", xaml, StringComparison.Ordinal);
